...
/**
 * PATCH /api/v1/programs/:id/marketplace — Set marketplace pricing and visibility
 */
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  if (program.createdBy !== auth.user.id) return errorResponse('Only the creator can set marketplace pricing', 403)
